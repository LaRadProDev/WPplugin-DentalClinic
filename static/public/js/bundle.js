...
Component.options.__file = "resources/assets/public/js/components/Filter.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dab7a006", Component.options)
  } else {
    hotAPI.reload("data-v-dab7a006", Component.options)
  }
...
Component.options.__file = "resources/assets/public/js/components/SelectCategories.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b5cce706", Component.options)
  } else {
    hotAPI.reload("data-v-b5cce706", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "resources/assets/public/js/components/Navigation.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f5d3fbce", Component.options)
  } else {
    hotAPI.reload("data-v-f5d3fbce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_router__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chenfengyuan_vue_countdown__ = __webpack_require__(61);





var MainPage = __webpack_require__(62);
var QuizPage = __webpack_require__(87);
var ReviewPage = __webpack_require__(103);

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_0_vue_router__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.use(__webpack_require__(126));
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component(__WEBPACK_IMPORTED_MODULE_3__chenfengyuan_vue_countdown__["a" /* default */].name, __WEBPACK_IMPORTED_MODULE_3__chenfengyuan_vue_countdown__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.filter('striphtml', function (value) {
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.filter('truncate', function (text, length, suffix) {
...
var routes = [{ path: '/', component: MainPage, beforeEnter: function beforeEnter(to, from, next) {
        __WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].commit('refreshQuizData');
        __WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].commit('refreshQuestions');
        next();
    } }, { path: '/start', component: QuizPage, beforeEnter: function beforeEnter(to, from, next) {
        if (!__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].state.quiz_data.terms || !__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].state.selectedQuestionsNum) {
            next('/');
        } else {
            next();
        }
    } }, { path: '/review', component: ReviewPage, beforeEnter: function beforeEnter(to, from, next) {
        if (!__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].state.questions.length) {
            next('/');
        } else {
            next();
        }
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$ajaxurl = window.ptt.ajax_url;
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$base_rest_url = window.ptt.base_rest_url;
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$base_url = window.ptt.base_url;
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$plugin_url = window.ptt.plugin_url;
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    mutations: {
        ...
        setQuestionsNum: function setQuestionsNum(state, questionsNum) {
            state.questionsNum = questionsNum;
        },
        setActiveQuestion: function setActiveQuestion(state, activeQuestion) {
            state.activeQuestion = activeQuestion;
        },
        setSelectedQuestionsNum: function setSelectedQuestionsNum(state, total) {
            state.selectedQuestionsNum = total;
        },
        setAnsQuestionInArray: function setAnsQuestionInArray(state, val) {
            __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(state.questions[val.question_key], 'incorrect', val.incorrect);
        },
        setAnsweredQuestionsData: function setAnsweredQuestionsData(state, answQuestionsData) {
            state.answered_question[answQuestionsData.questionIndex] = answQuestionsData;
        },
        refreshQuizData: function refreshQuizData(state) {
            state.quiz_data.time = 0;
            state.quiz_data.questions_num = 30;
            state.quiz_data.questions_type = 'new';
            state.quiz_data.terms = [];
        },
        refreshQuestions: function refreshQuestions(state) {
            state.questions = [];
        ...
        refreshTerms: function refreshTerms(state) {
            state.quiz_data.terms = [];
        }
    }
}));
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-2a17aa57"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/public/js/pages/MainPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2a17aa57", Component.options)
  } else {
    hotAPI.reload("data-v-2a17aa57", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(3)("5b8ae8cc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2a17aa57\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MainPage.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2a17aa57\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MainPage.vue");
...
// module
exports.push([module.i, "\n.welcome[data-v-2a17aa57] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -webkit-box-pack: end;\n      -ms-flex-pack: end;\n          justify-content: flex-end;\n}\n.welcome h2[data-v-2a17aa57] {\n    padding: 0;\n    margin: 0;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Filter_vue__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Filter_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Filter_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_XSelection_vue__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_XSelection_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_XSelection_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_SelectTime_vue__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_SelectTime_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_SelectTime_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Performance_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Performance_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_Performance_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_qs__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'filter-component': __WEBPACK_IMPORTED_MODULE_0__components_Filter_vue___default.a,
        'select-categories': __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue___default.a,
        'x-selection': __WEBPACK_IMPORTED_MODULE_2__components_XSelection_vue___default.a,
        'select-time': __WEBPACK_IMPORTED_MODULE_3__components_SelectTime_vue___default.a,
        'performance': __WEBPACK_IMPORTED_MODULE_4__components_Performance_vue___default.a
    },
    beforeMount: function beforeMount() {
        var _this = this;

        axios.get(this.$base_url + '/wp-json/wp/v2/users/me').then(function (response) {
            _this.user_name = response.data.name;
            _this.$store.commit('setUserId', response.data.id);

            var payload = {
                action: 'get_stats',
                user_id: _this.$store.state.userId
            };
            axios.post(_this.$ajaxurl, __WEBPACK_IMPORTED_MODULE_5_qs___default.a.stringify(payload)).then(function (response) {
        ...
        axios.post(this.$ajaxurl, __WEBPACK_IMPORTED_MODULE_5_qs___default.a.stringify(payload)).then(function (response) {
            _this.questions_num = response.data;
        }).catch(function (error) {
            console.log(error);
        });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        filterCategories: function filterCategories() {
            ...
            return this.$store.state.categories.filter(function (category) {
                return _this.$store.state.quiz_data.terms.includes(category.slug) ? true : false;
            });
        },
        countAllQuestions: function countAllQuestions() {
            var total = this.filterCategories().reduce(function (prev, category) {
                return prev + category.questions.length;
            }, 0);

            return total;
        },
        countIncorrectQuestions: function countIncorrectQuestions() {
            var total = this.filterCategories().reduce(function (prev, category) {
                return prev + category.questions.reduce(function (prev, question) {
                    if (question.histories.length > 0) {
                        var number = !!question.histories[0].incorrect ? 1 : 0;
                        return prev + number;
                    }
                    return prev + 0;
                }, 0);
        ...
        countNewQuestions: function countNewQuestions() {
            var total = this.filterCategories().reduce(function (prev, category) {
                return prev + category.questions.reduce(function (prev, question) {
                    if (question.histories.length == 0) {
                        return prev + 1;
        ...
        updateQuestionsNumber: function updateQuestionsNumber() {
    ...
    computed: {
        questionsNum: function questionsNum() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "filter" }, [
    _c("h3", { staticClass: "heading" }, [
      ...
      _vm.showQuestionsNum
        ? _c("span", { staticClass: "small" }, [
            _vm._v(_vm._s(_vm.questionsNum) + " questions selected")
          ])
        : _vm._e()
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "bar with-bg with-bg--secondary" }, [
      _c(
        "span",
        {
          staticClass: "small",
          class: { "with-bg--gray": _vm.by_category_active },
          attrs: {
            "data-slug": "medical_categories",
      ...
      _c(
        ...
        {
          staticClass: "small",
          class: { "with-bg--gray": _vm.by_year_active },
          attrs: { "data-slug": "years", "data-name": "Year(s)" },
          on: { click: _vm.changeFilter }
        },
        [_vm._v("BY YEAR")]
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-dab7a006", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5910bd0a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5cce706\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectCategories.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b5cce706\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectCategories.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toggleAll: function toggleAll() {
            if (this.toggled) {
                this.toggled = false;
                return this.checkedCategories = this.categories.map(function (cat) {
                    return cat.slug;
                });
            }
            this.toggled = true;
        ...
        retrieveTerms: function retrieveTerms(taxonomy, name) {
            var _this = this;
            ...
            axios.get(this.$base_rest_url + 'custom-taxonomies', {
                ...
                _this.toggled = true;
                _this.taxonomy = name;
                _this.categories = Object.values(response.data);
                _this.$store.commit('setCategories', Object.values(response.data));
                _this.loading = false;
        ...
        refreshCheckedTerms: function refreshCheckedTerms() {
            this.checkedCategories = [];
        },
        correctAnsweredNum: function correctAnsweredNum(questions) {
        ...
        incorrectAnsweredNum: function incorrectAnsweredNum(questions) {
            return questions.filter(function (question) {
                if (question.histories.length > 0) {
                    return question.histories[0].incorrect ? true : false;
                }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "select-categories" }, [
    _c("h4", { staticClass: "bar with-bg with-bg--gradient middle" }, [
      !_vm.name
        ? _c("span", [
            _vm._v(
              "Select " + _vm._s(_vm.taxonomy ? _vm.taxonomy : "Categories")
            )
          ])
        : _vm._e(),
      _vm.name ? _c("span", [_vm._v(_vm._s(_vm.name))]) : _vm._e()
    ]),
    _vm._v(" "),
    _vm.showQuestionsNum
      ? _c("span", { staticClass: "small" }, [_vm._v("Questions Answered")])
      : _vm._e(),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "select-categories__content with-bg with-bg--gray" },
      [
        _c(
          "div",
          {
          ...
          ? _c(
              ...
              [
                  ...
                  ? [
                      _c("li", { staticClass: "small" }, [
                        ...
                        _c("div", { staticClass: "flex align-center" }, [
                          _c("label", {
                            attrs: { for: "select-categories-all" },
                          ...
                          _c("span", [
                            _vm._v(
                              "All " +
                                _vm._s(
                                  _vm.taxonomy ? _vm.taxonomy : "Categories"
                                )
                            )
                          ])
                        ])
                ...
                _vm._l(_vm.categories, function(category) {
                  return _c("li", { staticClass: "small" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                      ...
                      domProps: {
                        ...
                        checked: Array.isArray(_vm.checkedCategories)
                          ? _vm._i(_vm.checkedCategories, category.slug) > -1
                    ...
                    _vm.showQuestionsNum
                      ? _c(
                          "span",
                          { staticClass: "select-categories__help-text" },
                          [
                            _vm._v(
                              "(" +
                                _vm._s(
                                  _vm.correctAnsweredNum(category.questions)
                                ) +
                                " "
                            ),
                            ...
                            _vm._v(
                              ", " +
                                _vm._s(
                                  _vm.incorrectAnsweredNum(category.questions)
                                ) +
                                " "
                            ),
                            _c("span", [_vm._v("incorrect of")]),
                            _vm._v(
                              " " + _vm._s(category.questions.length) + ")"
                            )
                          ]
                        )
                      : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b5cce706", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/XSelection.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f24c00e", Component.options)
  } else {
    hotAPI.reload("data-v-6f24c00e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_click_outside__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['title', 'placeholder', 'select', 'type'],
    data: function data() {
        return {
            active: false
        };
    ...
    methods: {
        ...
        setSelectItem: function setSelectItem(key) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "x-selection" }, [
    _c("h3", { staticClass: "heading" }, [_vm._v(_vm._s(_vm.title))]),
    _vm._v(" "),
    _c(
      "div",
      {
      ...
      [
        _c(
          "p",
          {
            staticClass: "bar with-bg with-bg--gradient middle justify-between",
            on: {
          ...
          [
            _c("span", { ref: "placeholder" }, [
              _vm._v(_vm._s(_vm.placeholder))
            ]),
            _vm._v(" "),
            _c("span", {
              staticClass: "arrow",
              class: _vm.active ? "arrow--up" : "arrow--down"
            })
          ]
        ),
        _vm._v(" "),
        _c(
          "ul",
          {
            ...
            staticClass: "with-bg with-bg--gray middle"
          },
          _vm._l(_vm.select, function(item, key) {
            return _c(
              "li",
              {
                on: {
                  click: function($event) {
                    return _vm.setSelectItem(key)
                  }
                }
              },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f24c00e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/SelectTime.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-37d4236e", Component.options)
  } else {
    hotAPI.reload("data-v-37d4236e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("6c81a7d4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-37d4236e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectTime.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-37d4236e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SelectTime.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slider_component__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_slider_component_theme_default_css__ = __webpack_require__(80);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        avgPerQuestion: function avgPerQuestion() {
            return Math.round(this.numberOfQuestions / this.time * 10) / 10;
        },
        avgWithText: function avgWithText() {
            var output = !this.time || !this.numberOfQuestions ? '' : 'an average ' + this.avgPerQuestion + ' minutes per question';
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "timer" },
    [
      _c("h3", { staticClass: "heading" }, [_vm._v("Timed Questions?")]),
      _vm._v(" "),
      _c("vue-slider", {
        attrs: { max: 90, dotSize: 20 },
        model: {
          value: _vm.time,
          callback: function($$v) {
            _vm.time = $$v
      ...
      _c(
        "p",
        { staticClass: "info middle", class: { active: _vm.avgWithText } },
        [
          _vm._v(_vm._s(_vm.avgWithText)),
          _c("br"),
          _vm._v("(national average 3 minutes per\n        question)")
        ]
      )
    ],
    1
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "limits flex justify-between middle" }, [
      _c("span", [_vm._v("NOT"), _c("br"), _vm._v("TIMED")]),
      _c("span", [_vm._v("90"), _c("br"), _vm._v("MINS")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-37d4236e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/Performance.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-53e0ae0a", Component.options)
  } else {
    hotAPI.reload("data-v-53e0ae0a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "performance" }, [
    _c("h3", { staticClass: "heading" }, [_vm._v("Questions Answered")]),
    _vm._v(" "),
    _c("div", { staticClass: "bar with-bg with-bg--gray" }, [
      _c(
        "span",
        {
          staticClass: "with-bg--gradient small",
          style: {
            width:
              (_vm.stats.answered_questions_num / _vm.questions_num) * 100 + "%"
          }
        },
        [
          _vm._v(
            _vm._s(_vm.stats.answered_questions_num) +
              " of " +
              _vm._s(_vm.questions_num)
          )
        ]
      )
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "score with-bg with-bg--gray" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "sector bigger" }, [
        _c("span", [_vm._v(_vm._s(_vm.stats.avg_score) + "%")])
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "rank with-bg with-bg--gray" }, [
      _c("div", { staticClass: "img" }, [
        _c("img", {
          attrs: {
            src: _vm.$plugin_url + "/static/public/img/bage.svg",
            alt: "label"
          }
        })
      ]),
      ...
      _c("span", { staticClass: "text big" }, [
        _vm._v(
          "You rank in the top " + _vm._s(_vm.stats.rank) + "% of students"
        )
      ])
    ])
  ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "text big" }, [
      _c("span", [_vm._v("Your Average Score")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-53e0ae0a", module.exports)
  }
}
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h2", { staticClass: "big" }, [
      _vm._v("Welcome, " + _vm._s(_vm.user_name))
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "container container--flex justify-between" }, [
      _c(
        "div",
        { staticClass: "column" },
        [
          _c(
            "div",
            { staticClass: "welcome with-underline" },
            [
              _c(
                "router-link",
                {
                  staticClass:
                    "btn big bar justify-center with-bg with-bg--primary heading",
                  attrs: { to: "/start" }
                },
                [_c("span", [_vm._v("QUICK START")])]
              )
            ],
            1
          ),
          _vm._v(" "),
          _c("filter-component", { attrs: { showQuestionsNum: true } }),
          _vm._v(" "),
          _c("select-categories", {
            attrs: { showQuestionsNum: true, tax: "medical_categories" }
          }),
          _vm._v(" "),
          _c("x-selection", {
            attrs: {
          ...
          _c("select-time"),
          _vm._v(" "),
          _c("router-link", { staticClass: "btn", attrs: { to: "/start" } }, [
            _c("span", [_vm._v("QUICK START")])
          ])
        ],
        1
      ...
      _c(
        ...
        [
          _vm._m(0),
          _vm._v(" "),
          _vm.stats && _vm.questions_num
            ? _c("performance", {
                attrs: { stats: _vm.stats, questions_num: _vm.questions_num }
              })
            : _c("p", { staticClass: "text-center" }, [
                _vm._v(
                  "We’re still collecting more data of your performance. Please Complete a more quizzes to see your performance"
                )
              ])
        ],
        1
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "with-underline" }, [
      _c("h3", { staticClass: "heading heading--margin-bottom" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2a17aa57", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/pages/QuizPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-441d2a1a", Component.options)
  } else {
    hotAPI.reload("data-v-441d2a1a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_TimeRemainder_vue__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_TimeRemainder_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_TimeRemainder_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_QuestionsPath_vue__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_QuestionsPath_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_QuestionsPath_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Question_vue__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Navigation_vue__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_qs__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'time-remainder': __WEBPACK_IMPORTED_MODULE_0__components_TimeRemainder_vue___default.a,
        'questions-path': __WEBPACK_IMPORTED_MODULE_1__components_QuestionsPath_vue___default.a,
        'question': __WEBPACK_IMPORTED_MODULE_2__components_Question_vue___default.a,
        'navigation': __WEBPACK_IMPORTED_MODULE_3__components_Navigation_vue___default.a
    },
    methods: {
        setAnswerQuestionsData: function setAnswerQuestionsData(answerIndex, questionIndex) {
        ...
        fetchQuestions: function fetchQuestions() {
            ...
            axios.post(this.$ajaxurl, __WEBPACK_IMPORTED_MODULE_4_qs___default.a.stringify(payload)).then(function (response) {
                _this.$store.commit('setQuestions', response.data);
                _this.$store.commit('setQuestionsNum', response.data.length);
                _this.$store.commit('setQuestion', response.data[_this.activeQuestion]);
            }).catch(function (error) {
                console.log(error);
            });
        }
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-07a701e3"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/public/js/components/TimeRemainder.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07a701e3", Component.options)
  } else {
    hotAPI.reload("data-v-07a701e3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("22c23031", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07a701e3\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TimeRemainder.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07a701e3\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TimeRemainder.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.time-remainder[data-v-07a701e3] {\n  padding: 30px 35px 20px;\n  text-align: center;\n  min-width: 200px;\n  margin-bottom: 35px;\n}\n.time-remainder span[data-v-07a701e3] {\n    font-size: 60px;\n    line-height: 1;\n    margin-bottom: 10px;\n    font-family: 'Roboto Mono', monospace;\n}\n.time-remainder p[data-v-07a701e3] {\n    margin: 0;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "time-remainder with-bg--gray container--flex flex-column align-center"
    },
    [
      _c("countdown", {
        attrs: { time: _vm.time * 60 * 1000 },
        scopedSlots: _vm._u([
          {
            key: "default",
            fn: function(props) {
              return [
                _vm._v(_vm._s(props.minutes) + ":" + _vm._s(props.seconds))
              ]
            }
          }
        ])
      ...
      _vm._v(" "),
      _c("p", { staticClass: "small" }, [_vm._v("Time remaining")])
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-07a701e3", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/QuestionsPath.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-abcd7bc6", Component.options)
  } else {
    hotAPI.reload("data-v-abcd7bc6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_qs__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toggleMarked: function toggleMarked(id, e) {
            var marked = e.target.dataset.marked == '0' ? '1' : '0';
    ...
    watch: {
        questions: function questions() {
            ...
            this.visibleQuestions = this.questions.filter(function (item, index) {
                return index <= _this.passedQuestions ? true : false;
            });
        },
        activeQuestion: function activeQuestion(val) {
            this.passedQuestions = this.passedQuestions <= val ? val : this.passedQuestions;
        },
        passedQuestions: function passedQuestions(val) {
            this.visibleQuestions = this.questions.filter(function (item, index) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "questions-path with-bg--gray" }, [
    _c("span", { staticClass: "middle" }, [_vm._v("QUESTIONS")]),
    _vm._v(" "),
    _c(
      "ul",
      _vm._l(_vm.visibleQuestions, function(question, key) {
        return _c(
          "li",
          {
            staticClass: "middle",
            class: { active: _vm.activeQuestion == key },
            on: {
              click: function($event) {
                _vm.activeQuestion = key
              }
            }
          },
          [
            ...
            _c(
              "span",
              {
                staticClass: "flag--gray",
                attrs: { "data-marked": "0" },
                on: {
                  click: function($event) {
                    return _vm.toggleMarked(question.ID, $event)
                  }
                }
              },
              [_vm._v("⚑")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-abcd7bc6", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/Question.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2fdff22b", Component.options)
  } else {
    hotAPI.reload("data-v-2fdff22b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_qs__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_qs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Navigation_vue__ = __webpack_require__(44);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'navigation': __WEBPACK_IMPORTED_MODULE_1__components_Navigation_vue___default.a
    },
    methods: {
        submitAnswer: function submitAnswer() {
            ...
            this.question.answers.forEach(function (item, index) {
                if (index == _this.answerIndex) {
                    _this.incorrect = item.correct_answer == '0' ? index : false;
                }
            });
            ...
            axios.post(this.$ajaxurl, __WEBPACK_IMPORTED_MODULE_0_qs___default.a.stringify(payload)).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        changeQuestion: function changeQuestion() {
            this.$root.$emit('change-question', this.activeQuestion);
        }
    }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "navigation container--flex align-center" }, [
    _vm.activeQuestion != 0
      ? _c(
          "a",
          {
            staticClass: "small",
          ...
          [_c("span", [_vm._v(" < ")]), _vm._v(" PREVIOUS QUESTION ")]
        )
      : _vm._e(),
    _vm._v(" "),
    _vm.activeQuestion + 1 != _vm.questionsNum
      ? _c(
          "a",
          {
            staticClass: "small",
          ...
          [_vm._v("NEXT QUESTION "), _c("span", [_vm._v(" > ")])]
        )
      : _vm._e()
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f5d3fbce", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "question" }, [
    _c("div", {
      staticClass: "content",
      domProps: { innerHTML: _vm._s(_vm.question.post_content) }
    }),
    _vm._v(" "),
    _c(
      "ul",
      ...
      _vm._l(_vm.question.answers, function(answer, key) {
        return _c("li", { key: answer.name }, [
          ...
          _c(
            "label",
            {
              staticClass: "answer middle flex align-center",
              attrs: { "data-value": key, for: "answer-" + key },
              on: { click: _vm.setAnswer }
            },
            [
              _c("span", { staticClass: "switch" }),
          ...
          _vm._v(" "),
          _vm.showAnswer && !_vm.timed && answer.correct_answer == 1
            ? _c("span", { staticClass: "check check--true" })
            : _vm._e(),
          _vm._v(" "),
          _vm.showAnswer &&
          !_vm.timed &&
          ...
          _vm.answerIndex == key
            ? _c("span", { staticClass: "check check--false" })
            : _vm._e()
        ])
      }),
      0
    ...
    _c(
      "div",
      { staticClass: "btn-wrapper justify-end flex" },
      [
        _c("navigation"),
        _vm._v(" "),
        _c(
    ...
    _vm._v(" "),
    _vm.showAnswer && !_vm.timed
      ? _c("div", { staticClass: "exp_content" }, [
          _c("h2", [_vm._v("Explanation")]),
          _vm._v(" "),
          _c("div", {
            domProps: { innerHTML: _vm._s(_vm.question.exp_content) }
          })
        ])
      : _vm._e()
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2fdff22b", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      "div",
      { staticClass: "header container--flex justify-between align-center" },
      [
        _c("p", { staticClass: "big heading" }, [
          _vm._v(
            "Question " +
              _vm._s(_vm.activeQuestion + 1) +
              " of " +
              _vm._s(_vm.questionsNum)
          )
        ]),
        _vm._v(" "),
        _c(
          ...
          [
            ...
            _c(
              "router-link",
              {
                staticClass: "small with-bg--secondary",
                attrs: { to: "/review" }
              },
              [_vm._v("\n                END QUIZ\n            ")]
            )
    ...
    _vm._v(" "),
    _c("div", { staticClass: "main container--flex justify-between" }, [
      _c(
        "div",
        { staticClass: "col-8" },
        _vm._l(_vm.questions, function(question, key) {
          return _vm.questionsNum && _vm.activeQuestion == key
            ? _c("question", {
                key: question.ID,
                attrs: {
                  question: question,
                  question_key: key,
                  answered_question: _vm.answered_question[key]
                    ? _vm.answered_question[key]
                    : false,
                  timed: _vm.time ? true : false
                }
              })
            : _vm._e()
        }),
      ...
      _c(
        ...
        [
          _vm.time
            ? _c("time-remainder", { attrs: { time: _vm.time } })
            : _vm._e(),
          _vm._v(" "),
          _c("questions-path")
        ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-441d2a1a", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/pages/ReviewPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bde41994", Component.options)
  } else {
    hotAPI.reload("data-v-bde41994", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ButtonGroup_vue__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ButtonGroup_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_ButtonGroup_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_QuestionList_vue__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Statistics_vue__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Statistics_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_Statistics_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_qs__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_qs__);
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'filter-component': __WEBPACK_IMPORTED_MODULE_0__components_Filter_vue___default.a,
        'select-categories': __WEBPACK_IMPORTED_MODULE_1__components_SelectCategories_vue___default.a,
        'button-group': __WEBPACK_IMPORTED_MODULE_2__components_ButtonGroup_vue___default.a,
        'statistics': __WEBPACK_IMPORTED_MODULE_4__components_Statistics_vue___default.a,
        'question-list': __WEBPACK_IMPORTED_MODULE_3__components_QuestionList_vue___default.a
    },
    methods: {
        setQuestionsNumber: function setQuestionsNumber(val) {
            this.total_questions = val;
        },
        filterQuestions: function filterQuestions(text, type) {
            var _this = this;

            var filtered_question = this.questions;

            filtered_question = filtered_question.filter(function (question) {
                if (!_this.marked) {
                    return true;
                }
            ...
            filtered_question = filtered_question.filter(function (question) {
                if (_this.incorrect === false) {
                    return true;
                } else if (_this.incorrect === true) {
                    return question.incorrect !== false ? true : false;
                }

                return question.incorrect === _this.incorrect ? true : false;
            });

            filtered_question = filtered_question.filter(function (question) {
                var includes = false;

                if (!_this.filterTermsByCat.length && !_this.filterTermsByYear.length) {
                    return true;
                }

                question.terms.forEach(function (term) {
                    if (_this.filterTermsByCat.includes(term.slug) || _this.filterTermsByYear.includes(term.slug)) {
                        includes = true;
                    }
                });
        ...
        setFilterTerms: function setFilterTerms(terms, tax) {
            if (tax == 'years') {
        ...
        setFilterType: function setFilterType(text, type) {
    ...
    created: function created() {
        ...
        var attempted = this.$store.state.questions.filter(function (q) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-8cf07e90"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/public/js/components/ButtonGroup.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8cf07e90", Component.options)
  } else {
    hotAPI.reload("data-v-8cf07e90", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5fa3f7ad", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8cf07e90\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ButtonGroup.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8cf07e90\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ButtonGroup.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.button-group[data-v-8cf07e90] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  padding: 10px;\n  margin-left: -5px;\n  margin-right: -5px;\n  background-color: #133658;\n  border-radius: 20px;\n  margin-top: 30px;\n}\n.button-group button[data-v-8cf07e90] {\n    font-size: 16px;\n    padding: 5px 15px;\n    text-align: center;\n    border-radius: 10px;\n    color: white;\n    text-transform: uppercase;\n    font-weight: 500;\n    -ms-flex-preferred-size: 100%;\n        flex-basis: 100%;\n    background-color: transparent;\n    border: none;\n}\n.button-group button.active[data-v-8cf07e90] {\n      background-color: #ECE9E7;\n      color: #133658;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setActiveButton: function setActiveButton(key, e) {
            this.activeButton = key;
            this.$emit('button-group-clicked', e.target.innerText, this.type);
        }
    }
});
    ...
    _vm._l(_vm.buttons, function(button, key) {
      return _c(
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.setActiveButton(key, $event)
            }
          }
        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8cf07e90", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/QuestionList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11b0f32e", Component.options)
  } else {
    hotAPI.reload("data-v-11b0f32e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("2a5d86fe", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-11b0f32e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./QuestionList.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-11b0f32e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./QuestionList.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.question-list {\n  margin: 0;\n}\n.question-list-item {\n  position: relative;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  padding: 20px 0;\n  cursor: pointer;\n  list-style: none;\n}\n.question-list-item:last-child .question-list-item__line {\n    display: none;\n}\n.question-list-item h4 {\n    font-size: 32px;\n    margin: 0;\n    font-weight: 400;\n    color: #133658;\n}\n.question-list-item p {\n    margin: 0;\n}\n.question-list-item .check {\n    width: 34px;\n    -ms-flex-negative: 0;\n        flex-shrink: 0;\n    margin-right: 20px;\n    position: static;\n}\n.question-list-item .flag--gray, .question-list-item .flag--red {\n    font-size: 30px;\n    -ms-flex-item-align: center;\n        align-self: center;\n}\n.question-list-item__line {\n  position: relative;\n}\n.question-list-item__line:after {\n    content: '';\n    position: absolute;\n    top: 50%;\n    left: 13px;\n    width: 8px;\n    height: calc(100% + 40px);\n    background-color: #8a8a8a;\n    z-index: -1;\n}\n.question-list-item__container {\n  width: 100%;\n}\n.question-list-item__content {\n  font-size: 18px;\n  color: #1E646E;\n}\n.question-list-item__date {\n  margin-right: 30px;\n  width: 90px;\n  display: block;\n  -ms-flex-negative: 0;\n      flex-shrink: 0;\n  text-align: center;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__QuestionModal_vue__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__QuestionModal_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__QuestionModal_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        marked: function marked(_marked) {
            return parseInt(_marked) ? 'flag--red' : 'flag--gray';
        }
    },
    components: {
        'question-modal': __WEBPACK_IMPORTED_MODULE_0__QuestionModal_vue___default.a
    }
});
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-8a979a1c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/public/js/components/QuestionModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8a979a1c", Component.options)
  } else {
    hotAPI.reload("data-v-8a979a1c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7f6b4b3a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8a979a1c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./QuestionModal.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8a979a1c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./QuestionModal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.question-modal[data-v-8a979a1c] {\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  margin: auto;\n  max-width: 700px;\n  height: 600px;\n  background-color: white;\n  border-radius: 20px;\n  padding: 30px;\n  overflow-x: scroll;\n  -webkit-box-shadow: 0 0 40px 10px #C4D3D5;\n          box-shadow: 0 0 40px 10px #C4D3D5;\n}\n.question-modal .select-answer .answer[data-v-8a979a1c] {\n    margin-right: 0;\n}\n.question-modal__cross[data-v-8a979a1c] {\n  position: absolute;\n  right: 10px;\n  top: 10px;\n  width: 32px;\n  height: 32px;\n  cursor: pointer;\n}\n.question-modal__cross[data-v-8a979a1c]:after, .question-modal__cross[data-v-8a979a1c]:before {\n    content: '';\n    display: block;\n    width: 32px;\n    height: 4px;\n    background-color: #000;\n    position: relative;\n    top: 10px;\n}\n.question-modal__cross[data-v-8a979a1c]:after {\n    -webkit-transform: rotate(45deg);\n            transform: rotate(45deg);\n}\n.question-modal__cross[data-v-8a979a1c]:before {\n    -webkit-transform: rotate(-45deg);\n            transform: rotate(-45deg);\n    top: 14px;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        activateModal: function activateModal(key) {
            var _this = this;

            setTimeout(function () {
                _this.question = _this.questions[key];
                _this.active = true;
            }, 200);
        },
        deactivateModal: function deactivateModal() {
            this.active = false;
        }
    },
    directives: {
...
var render = function() {
  ...
  return _vm.active
    ? _c(
          ...
          directives: [
            {
              name: "click-outside",
              rawName: "v-click-outside",
              value: _vm.deactivateModal,
              expression: "deactivateModal"
            }
          ],
        ...
        [
          _c("div", {
            staticClass: "question-modal__cross",
            on: { click: _vm.deactivateModal }
          }),
          _vm._v(" "),
          _c("h2", [_vm._v(_vm._s(_vm.question.post_title))]),
          _vm._v(" "),
          _c("div", {
            staticClass: "question-modal__content",
            domProps: { innerHTML: _vm._s(_vm.question.post_content) }
          }),
          _vm._v(" "),
          ...
          _vm._v(" "),
          _c("div", {
            staticClass: "question-modal__exp-content",
            domProps: { innerHTML: _vm._s(_vm.question.exp_content) }
          }),
          _vm._v(" "),
          _c(
            "ul",
            { staticClass: "select-answer select-answer--disabled" },
            _vm._l(_vm.question.answers, function(answer, key) {
              return _c("li", { key: answer.name }, [
                _c(
                  "div",
                  { staticClass: "answer middle container--flex align-center" },
                  [
                    _vm._v(
                      "\n                " +
                        _vm._s(answer.name) +
                ...
                answer.correct_answer === "1"
                  ...
                  : _vm._e(),
                _vm._v(" "),
                answer.correct_answer === "0" && _vm.question.incorrect === key
                  ? _c("span", { staticClass: "check check--false" })
                  : _vm._e()
              ])
            }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8a979a1c", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        _vm._l(_vm.questions, function(question, key) {
          return _c(
            "li",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.showModal(key)
                }
              }
            },
            [
              _c("span", { staticClass: "question-list-item__line" }),
              _vm._v(" "),
              question.incorrect === false
                ? _c("span", { staticClass: "check check--true" })
                : _c("span", { staticClass: "check check--false" }),
              _vm._v(" "),
              _c("div", { staticClass: "question-list-item__container" }, [
                _c("h4", { staticClass: "question-list-item__title" }, [
                  _vm._v(_vm._s(question.post_title))
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "question-list-item__content" }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(
                        _vm._f("truncate")(
                          _vm._f("striphtml")(question.post_content),
                          70,
                          "..."
                        )
                      ) +
              ...
              _vm._v(" "),
              _c("span", { class: _vm.marked(question.marked) }, [_vm._v("⚑")])
            ]
          )
        }),
        0
      ...
      _vm._v(" "),
      _c("question-modal", { attrs: { questions: _vm.questions } })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-11b0f32e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/public/js/components/Statistics.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b0d6ecb0", Component.options)
  } else {
    hotAPI.reload("data-v-b0d6ecb0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("71d24208", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b0d6ecb0\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Statistics.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b0d6ecb0\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Statistics.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("div", { staticClass: "statistics" }, [
    _c("div", { staticClass: "statistics__score" }, [
      _c("div", [
        _c("span", { staticClass: "statistics__score-number" }, [
          _vm._v(_vm._s(Math.round(_vm.avgScore)) + "%")
        ]),
        _vm._v(" "),
        _c("span", { staticClass: "statistics__score-text" }, [
          _vm._v("Your score")
        ])
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "statistics__questions" }, [
      _c("ul", [
        _c("li", { staticClass: "statistics__questions-item" }, [
          _c("span", { staticClass: "statistics__questions-item-number" }, [
            _vm._v(_vm._s(_vm.answered))
          ]),
          _vm._v(" "),
          _c("span", { staticClass: "statistics__questions-item-text" }, [
            _vm._v("Correct")
          ])
        ]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b0d6ecb0", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      ...
      { staticClass: "header container--flex justify-between align-center" },
      [
        _c("p", { staticClass: "big heading" }, [_vm._v("Review")]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "controls" },
          [
            _c(
              "router-link",
              { staticClass: "small link", attrs: { to: "/" } },
              [
                _vm._v("\n                Return to dashboard "),
                _c("span", [_vm._v(" > ")])
              ]
    ...
    _vm._v(" "),
    _c("div", { staticClass: "container--flex justify-between" }, [
      _c(
        "div",
        { staticClass: "column" },
        [
          _vm.questions
            ? _c("statistics", {
                ...
                on: { "questions-num": _vm.setQuestionsNumber }
              })
            : _vm._e(),
          _vm._v(" "),
          _c("div", { staticClass: "review-filter" }, [
            _c("h3", [_vm._v("Filter Questions")]),
            _vm._v(" "),
            _c("span", [
              _vm._v(_vm._s(_vm.filtered_question.length) + " questions found")
            ])
          ]),
          _vm._v(" "),
          _c("button-group", {
            attrs: {
              buttons: ["All questions", "Incorrect questions"],
              type: "correctness"
            },
            on: { "button-group-clicked": _vm.setFilterType }
          }),
          _vm._v(" "),
          _c("button-group", {
            attrs: {
              buttons: ["All questions", "Flagged questions"],
              type: "flagged"
            },
            on: { "button-group-clicked": _vm.setFilterType }
          }),
          ...
          _vm._v(" "),
          _c("select-categories", {
            attrs: { tax: "years", name: "Filter by Year", reviewPage: true }
          })
        ],
        1
      ),
      ...
      _c(
        ...
        { staticClass: "column" },
        [
          _vm.filtered_question
            ? _c("question-list", {
                attrs: { questions: _vm.filtered_question }
              })
            : _vm._e()
        ],
        1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bde41994", module.exports)
  }
}
